...
export class CreateDataSourceTable1748449253402 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TYPE "public"."data_source_type_enum" AS ENUM('web_crawl', 'file_upload', 'api_import', 'manual_input')`);
        await queryRunner.query(`CREATE TYPE "public"."data_source_status_enum" AS ENUM('pending', 'processing', 'completed', 'failed')`);
