...
export class CreatePostTable1748601025949 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "chatbot_history" ADD "conversation_id" uuid`);
        await queryRunner.query(`ALTER TABLE "chatbot_history" ADD CONSTRAINT "FK_a3a9dfc39c6b353c05f77a515a5" FOREIGN KEY ("conversation_id") REFERENCES "conversations"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "chatbot_history" DROP CONSTRAINT "FK_a3a9dfc39c6b353c05f77a515a5"`);
        await queryRunner.query(`ALTER TABLE "chatbot_history" DROP COLUMN "conversation_id"`);
