...
export const TOUR_DATA: TourData = {
  university: {
    ...
    description: "Một trong những đại học hàng đầu Việt Nam với cơ sở vật chất hiện đại và chất lượng đào tạo xuất sắc.",
  ...
  locations: [
    {
      ...
      description: "Thư viện hiện đại với hơn 200,000 đầu sách và tài liệu số, cùng hàng trăm chỗ ngồi học tập, khu vực thảo luận nhóm và phòng nghiên cứu.",
      type: "facility",
      ...
      media: [
        {
          ...
          description: "Không gian yên tĩnh với ánh sáng tự nhiên và chỗ ngồi thoải mái.",
        },
        {
          id: "lib-2",
          type: "image",
          ...
          description: "Trang bị hơn 50 máy tính hiện đại cho sinh viên nghiên cứu.",
        },
        {
          id: "lib-3",
          type: "video",
          url: "https://example.com/videos/library-tour.mp4",
          thumbnail: "https://images.unsplash.com/photo-1541339907198-e08756dedf3f?ixlib=rb-1.2.1&auto=format&fit=crop&w=1350&q=80",
          title: "Tour thư viện",
    ...
    },
    {
      ...
      description: "Tòa nhà hiện đại với các phòng lab máy tính tiên tiến, phòng thực hành AI, phòng seminar và không gian làm việc cho sinh viên.",
      type: "academic",
      ...
      media: [
        {
          ...
          description: "Trang bị hơn 100 máy tính hiệu năng cao cho các môn học lập trình.",
        },
        {
          id: "cs-2",
          type: "360",
      ...
      majors: [
        {
          ...
          description: "Chương trình đào tạo toàn diện về lập trình, cấu trúc dữ liệu, thuật toán và kỹ thuật phần mềm.",
          highlightPoints: [
        ...
        },
        {
          ...
          description: "Chương trình chuyên sâu về machine learning, deep learning và các ứng dụng AI trong thực tế.",
          highlightPoints: [
        ...
        {
          name: "An ninh mạng",
          description: "Đào tạo về bảo mật hệ thống, mạng máy tính, mã hóa và phòng chống tấn công mạng.",
          highlightPoints: [
      ...
      people: [
        {
          ...
          role: "Trưởng khoa",
          quote: "Chúng tôi luôn đặt sinh viên vào trung tâm của mọi hoạt động đào tạo.",
    ...
    },
    {
      ...
      description: "Cơ sở đào tạo hiện đại với các phòng học thông minh, trung tâm mô phỏng kinh doanh và không gian làm việc nhóm sáng tạo.",
      type: "academic",
      ...
      media: [
        ...
        },
        {
          ...
          thumbnail: "https://images.unsplash.com/photo-1556761175-b413da4baf72?ixlib=rb-1.2.1&auto=format&fit=crop&w=1350&q=80",
      ...
      majors: [
        {
          ...
          description: "Chương trình đào tạo toàn diện về quản lý, marketing, tài chính và chiến lược kinh doanh.",
          highlightPoints: [
        ...
        },
        {
          ...
          description: "Chương trình đào tạo về phân tích tài chính, đầu tư, quản lý rủi ro và hoạt động ngân hàng.",
          highlightPoints: [
    ...
    },
    {
      ...
      description: "Khu ký túc xá hiện đại với đầy đủ tiện nghi cho sinh viên, bao gồm phòng ở tiện nghi, khu vực sinh hoạt chung và các dịch vụ hỗ trợ.",
      type: "housing",
      ...
      media: [
        {
          ...
          description: "Phòng ở tiêu chuẩn dành cho 4 sinh viên với đầy đủ tiện nghi.",
        },
        {
          id: "dorm-2",
          type: "image",
    ...
    },
    {
      ...
      description: "Trung tâm thể thao đa năng với các sân bóng đá, bóng rổ, bể bơi và phòng tập đa chức năng.",
      type: "recreation",
      ...
      media: [
        {
          ...
          title: "Sân bóng đá",
          description: "Sân bóng đá tiêu chuẩn với mặt cỏ nhân tạo chất lượng cao.",
        },
        {
          id: "sports-2",
          type: "image",
